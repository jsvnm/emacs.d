...
(defvar bh/organization-task-id "B1B7101C-4061-4AA9-B3CC-78999F101C67")
...
(setq org-columns-default-format "%42ITEM(Task) %TODO %5Effort(Estim){:} %5CLOCKSUM(spent)")
...
'(("t" "Todo" entry (file+headline "" "Tasks")
	 "* TODO %?\n  %U\n  %a\n  %K\n")
		 ("j" "Journal" entry (file+datetree "")
			"* %<%H:%M> %?\n  %a | %K\n")
		 ("U" "URL/TITLE/BODY" entry (file+headline "" "Webpages")
			"* %c\n  %U\n  #+begin_quote\n  %i\n  #+end_quote\n" :immediate-finish t)))
...
(setq org-todo-keyword-faces
      (quote (("TODO"				:weight bold		:background "red"					 :foreground "black")
              ("NEXT"				:weight bold		:background "yellow"			 :foreground "black")
              ("DONE"				:weight bold		:background "forest green" :foreground "black")
              ("WAITING"		:weight bold		:background "orange"			 :foreground "black")
              ("HOLD"				:weight bold		:background "magenta"			 :foreground "black")
              ("CANCELLED"	:weight bold		:background "forest green" :foreground "black")
              ("PHONE"			:weight bold		:background "forest green" :foreground "black"))))
